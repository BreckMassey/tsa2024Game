...
public class BigRookBoss : BossParent
{
    ...
    void spawnPawns(int count)
    {
        ...
        {
            GameObject spawnedPawn = Instantiate(walkingPawnPrefab, new Vector3(Random.Range(0.0f, 1.0f) > 0.5 ? -30 : 30, -3.4f+3* Mathf.Floor(Random.Range(0,4)), 11), Quaternion.identity);
